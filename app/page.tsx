 ...
 useEffect(() => {
  ...
  apolloClient
    .query<{
      ...
      variables: { leaderboardLimit: 5 },
    })
    .then((result) => {
      setProfileCount(result.data?.profileCount || 0);
      setLeaderboard(result.data?.leaderboard || []);
      setLeaderboardCount(result.data?.leaderboard?.length || 0);
    })
    .catch((error) => {
